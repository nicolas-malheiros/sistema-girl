...
window.onload = function() {
  ...
  function loadQuestions() {
    const preExistingQuestions = JSON.parse(localStorage.getItem('preExistingQuestions')) || [
      "O que te chamou mais atenção em mim quando a gente se conheceu?",
      "O que você está sentindo sobre a gente até agora?",
      "Como você imagina um momento perfeito nosso juntos?",
    ];
